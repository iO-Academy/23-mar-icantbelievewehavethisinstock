...
const getStockLevelController = require('../controllers/getStockLevelController');
const updateStockLevelController = require('../controllers/updateStockLevelController');
...
const routes = (app) => {
    ...
    app.get('/products/:SKU', getStockLevelController.getStockLevel) // Get stock levels
    app.put('/update/:SKU', updateStockLevelController.updateStockLevel) // Update stock levels
}
